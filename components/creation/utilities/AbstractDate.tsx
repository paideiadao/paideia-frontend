...
const AbstractDate: React.FC<{value: Date, setValue: Function, label: string, width: string, mr?: string}> = (props) => {
    let temp = props
    ...
    <DatePicker
      ...
      renderInput={(params) => (
        <TextField
          {...params}
          helperText={null}
          sx={{ width: props.width, svg: { color: "primary.main" }, mr: props.mr }}
        />
      )}
    />
