...
const ActionSelection: React.FC<IActionType> = (props) => {
  return (
    <Box sx={{ width: "100%", alignItems: "center", display: "flex", mt: '.75rem', mb: '.75rem' }}>
      <Box sx={{width: '8%', alignItems: 'center', justifyContent: 'center', color: 'primary.main', display: 'flex'}}>
        {props.icon}
      </Box>
