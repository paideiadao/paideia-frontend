...
import { Box, IconButton, FormControl, InputLabel, Select, SelectChangeEvent, MenuItem, Button } from '@mui/material';
import { categories, IFilters } from '@pages/dao/[id]/activity';
    ...
    return (
      <Box sx={{ width: "100%", height: "100%", position: "relative" }}>
        ...
        >
          Filters
          <IconButton
            sx={{ ml: "auto", color: themeContext.theme === DarkTheme ? "black" : 'white' }}
            size="small"
            onClick={props.close}
          >
            <CloseIcon />
