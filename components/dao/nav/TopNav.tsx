    ...
    >
      ...
      >
        ...
        Toggle Theme
          ...
          <Box sx={{ml: '.5rem', mr: '.5rem', display: 'flex', alignItems: 'center'}}>
              <Badge badgeContent={1} color='primary' >
                <NotificationsIcon sx={{fontSize: '1.1rem', opacity: globalContext.api.theme === DarkTheme ? '1' : '.5'}} />
          ...
          <Box sx={{ml: '1rem', display: 'flex', alignItems: 'center'}}>
              ...
              <Box sx={{display: 'flex', flexDirection: 'column', justifyContent: 'center'}}>
                  ...
                  <Box sx={{color: 'primary.lightText', fontSize: '.7rem'}}>Lvl 7 | Philosopher</Box>
