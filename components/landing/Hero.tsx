    ...
    <Container sx={{ flexGrow: 1, px: '24px' }}>
      <Box
        sx={{
          ...
          transform: { xs: 'translate(-50%, 0)', sm: 'translate(-50%, 0)', md: 'translate(-50%, 0)' },
          overflow: 'hidden',
          zIndex: '-1',
          ml: '-24px',
        }}
      ...
      >
        <Grid item>
          <SectionTitle title="A Web3 DAO Management Software Suite" marginBottom="80px" />
          <Typography
            sx={{
        ...
        <Grid item>
          ...
          <Grid container spacing={{ xs: 4, md: 0.5 }} direction={{ xs: 'row', md: 'column' }} sx={{ pt: 3, pb: { xs: 3, md: 0 } }}>
            <Grid item>
              <Link
                href="/"
                target="_blank"
      ...
      <Grid container spacing={3} sx={{ mb: 6, mt: { xs: 6, md: 0 } }}>
        <Grid item>
          <Grid container spacing={2}>
            <Grid item >
              <Box sx={{ width: '6px', minHeight: '100%', background: 'linear-gradient(161.68deg, #6FA1A9 19.58%, #ED7E21 84.97%)' }}>
              </Box>
            </Grid>
            <Grid item>
        ...
        <Grid item>
          <Grid container justifyContent="space-around" spacing={2} sx={{ color: '#777' }}>
            <Grid item>
              LogoWideLogo
            </Grid>
            <Grid item>
