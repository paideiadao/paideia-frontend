...
import { Grid, Container, Typography, Button, Tabs, Tab, Box, useMediaQuery } from '@mui/material'
...
const tabs = [
  ...
  },
  {
    ...
    content: 'You can share your NFT proceeds by using a DAO to distribute and control raised funds',
    link: '/',
    ...
    <>
      {!sizeMd ? (
        tabs.map(({ image }, i: number) => {
          return (
            <TabPanel value={value} index={i} key={i} sx={{ position: 'relative', mt: '100px' }}>
              <Box sx={{
              ...
              <Box sx={{
                ...
                {sizeMd ? (
                  ...
                  <Image src={image} layout="responsive" width={585} height={800} />
                )}
              </Box>
            </TabPanel>
          )
      ...
      <Container sx={{ position: 'relative', flexGrow: 1, px: '24px', mt: { xs: '-550px', sm: '-1000px', md: '0' } }}>
        <Grid
          container
          spacing={12}
          alignItems="center"
              ...
              return (
                <TabPanel value={value} index={i} key={i}>
                  <Box sx={{
                    ...
                    {sizeMd ? (
                      <Image src={image} layout="fixed" width={width} height={height} />
                    ) : (
                      null
                    )}
                  </Box>
