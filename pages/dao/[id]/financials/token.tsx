...
const Token: React.FC = () => {
  ...
  return <Layout width="97%">
    <Box sx={{width: '100%', display: 'flex', alignItems: 'center'}}>
      <Header title="Token Information" large/>
      <Link href={id === undefined ? '/dao/financials/token/burn' : `/dao/${id}/financials/token/burn`}>
        <Button variant='contained' sx={{ml: 'auto'}} endIcon={<LocalFireDepartmentIcon/>}>
          Burn Tokens
        </Button>
      </Link>
