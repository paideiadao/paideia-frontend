      ...
      <Container id="navContainer">
        <PageNav navLinks={navLinks}>
          ...
          >
            ...
            <Typography variant="body2">
              This is a <Link href="/test">paragraphy variant</Link>.{" "}
              <Link href="https://ergopad.io">External Link</Link> lorem ipsum
              dolor sit amet, consectetur adipiscing elit. Nam hendrerit nisi
              sed sollicitudin pellentesque. Nunc posuere purus rhoncus pulvinar
              aliquam. Ut aliquet tristique nisl vitae volutpat. Nulla aliquet
              porttitor venenatis. Donec a dui et dui fringilla consectetur id
              nec massa. Aliquam erat volutpat. Sed ut dui ut lacus dictum
