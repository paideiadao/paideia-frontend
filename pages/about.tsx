          ...
          <Grid item md={9}>
              ...
              <Grid container>
                ...
                <Grid item md={7}>
                  <Typography sx={{ fontWeight: "700", mb: "48px" }}>
                    Anyone who needs to manage a treasury as a group will
                    benefit from these tools. Examples include:
                  </Typography>
                  <Grid
                    container
            ...
            <section id="theproblem">
              ...
              >
                ...
                accomplish something in the real world that benefits them or
                their communities. But, a DAO needs software to enable it to
                function as a decentralized, autonomous organization. DAOs need
                an off-the-shelf DAO toolkit, one that provides:
              </SectionHeading>
            ...
            <section id="thesolution">
              ...
              <SectionHeading
                ...
                sx={{ mb: "180px" }}
              >
                It is designed to make it easy for anyone to create, manage and
                be involved in a DAO, as well as facilitate the distribution of
